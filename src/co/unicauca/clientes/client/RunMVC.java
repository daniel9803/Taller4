...
public class RunMVC {
    ...
    public RunMVC() {
        ...
        GUIEstadisticaPorSexoGrafica myView4 = new
        GUIEstadisticaPorSexoGrafica(900,460);
        myModel.addObserver(myView);
        myModel.addObserver(myView2);
        myModel.addObserver(myView3);
        myModel.addObserver(myView4);
        GUIBusquedaClientesController myController = new
       GUIBusquedaClientesController();
